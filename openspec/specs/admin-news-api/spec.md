...
After successfully creating an article, the system SHALL enqueue an `embedding_jobs` row for that article. This is a fire-and-forget side effect — the API response SHALL NOT wait for embedding generation.
