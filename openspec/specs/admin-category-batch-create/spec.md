...
The category creation page SHALL present a dynamic list of rows, each containing a name and auto-generated slug. The admin SHALL be able to add rows, remove rows, and edit slugs manually. Submitting SHALL create all rows in a single atomic operation.
