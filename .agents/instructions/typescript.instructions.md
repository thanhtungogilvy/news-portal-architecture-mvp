...
## Nuxt TypeScript Aliases

Repo này dùng Nuxt-generated tsconfig:
...
Không tự thêm path aliases vào `tsconfig.json` nếu Nuxt đã generate. Khi cần đổi alias/source dir, sửa `nuxt.config.ts` thay vì hand-edit `.nuxt`.
