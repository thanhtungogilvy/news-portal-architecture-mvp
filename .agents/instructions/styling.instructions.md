---
applyTo: "app/**/*.vue, app/**/*.css, app/**/*.scss"
---
...
## Exceptions — custom CSS

Chỉ viết custom CSS cho những thứ Tailwind không express được. Nếu tạo global CSS/SCSS trong `app/assets`, phải register trong `nuxt.config.ts`:
...
/* ✓ Font-face — chỉ thêm sau khi font file tồn tại trong public/fonts/ */
@font-face {
  font-family: 'Inter';
