...
<template>
  ...
  <header class="sticky top-0 z-40 border-b border-slate-200 bg-white">
    <div class="flex items-center justify-between px-4 py-4 sm:px-6 lg:px-12 lg:py-5">
      ...
      <div class="flex items-center gap-2 lg:gap-4">
        ...
        <a
          ...
          class="hidden lg:flex min-h-[42px] items-center justify-center rounded-lg bg-navy-900 px-[22px] py-2.5 text-sm font-medium leading-none text-white transition-opacity hover:opacity-90"
        >
          Đăng ký
        </a>
        ...
        <NuxtLink
          to="/news"
          class="flex size-9 items-center justify-center rounded-lg text-navy-900 hover:bg-slate-100 lg:hidden"
          aria-label="Tìm kiếm"
        >
        ...
        <!-- Mobile hamburger -->
        <button
          class="flex size-9 flex-col items-center justify-center gap-1.5 rounded-lg text-navy-900 hover:bg-slate-100 lg:hidden"
